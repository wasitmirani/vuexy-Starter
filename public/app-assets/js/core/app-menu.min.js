!(function (e, n, a) {
    ...
    n.documentElement.style.setProperty("--vh", t + "px"),
        (a.app = a.app || {});
    var i = a("body"),
    ...
    (a.app.menu = {
                ...
                if (!0 === a(".main-menu").data("scroll-to-active")) {
                    ...
                    if (
                        ...
                        i.hasClass("menu-collapsed") &&
                            a(".main-menu-content li.sidebar-group-active")
                                .length &&
                            (e = n.querySelector(
                    ...
                    setTimeout(function () {
                        a.app.menu.container
                            .stop()
                            .animate({ scrollTop: o }, 300),
        ...
        open: function () {
            this.transit(
                function () {
                    i
                        .removeClass("menu-hide menu-collapsed")
                        .addClass("menu-open"),
                        (this.hidden = !1),
                        (this.expanded = !0),
        ...
        hide: function () {
            this.transit(
                function () {
                    i
                        .removeClass("menu-open menu-expanded")
                        .addClass("menu-hide"),
                        (this.hidden = !0),
                        (this.expanded = !1),
                        i.hasClass("vertical-overlay-menu") &&
        ...
        toOverlayMenu: function (e, n) {
            ...
            "vertical-menu-modern" == n
                ? "lg" == e || "md" == e || "sm" == e || "xs" == e
                    ? i.hasClass(a) &&
                      i.removeClass(a).addClass("vertical-overlay-menu")
                    : i.hasClass("vertical-overlay-menu") &&
        ...
        changeMenu: function (e) {
            ...
            "xl" === e
                ? (i
                      .removeClass(
                          "vertical-layout vertical-overlay-menu fixed-navbar"
                      )
                      .addClass(i.data("menu")),
                  a("nav.header-navbar").removeClass("fixed-top"),
                  n.removeClass().addClass(o),
                  a("a.dropdown-item.nav-has-children").on(
                      "click",
                      function () {
        ...
        reset: function () {
            (this.expanded = !1),
                ...
                (this.hidden = !1),
                i.removeClass(
                    "menu-hide menu-open menu-collapsed menu-expanded"
                );
        },
    }),
        (a.app.nav = {
                ...
                a(".navigation-main")
                    ...
                    a(".navbar-header, .main-menu")
                        .on("mouseenter", function () {
                            if (
                                "vertical-menu-modern" == i.data("menu") &&
                                (a(".main-menu, .navbar-header").addClass(
                                    "expanded"
                                ),
                                i.hasClass("menu-collapsed"))
                            ) {
                                ...
                                e
                                    ...
                                    e
                                        .addClass("open")
                                        .removeClass("menu-collapsed-open");
                            }
                        })
                    ...
                    a(".main-menu-content").on("mouseleave", function () {
                        i.hasClass("menu-collapsed") &&
                            ...
                            a(".main-menu-content")
                                .children("ul.menu-content")
                                .remove()),
                            a(".hover", ".navigation-main").removeClass(
                                "hover"
                            );
                    }),
                    a(".navigation-main li.has-sub > a").on(
                        "click",
                        function (e) {
                            e.preventDefault();
                        }
            ...
            _bindAnimationEndEvent(n, t) {
                ...
                var i = function (e) {
                    e.target === n &&
                        (a.app.nav._unbindAnimationEndEvent(n), t(e));
                };
